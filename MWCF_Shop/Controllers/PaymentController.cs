...
namespace MWCF_Shop.Controllers
{
    ...
    {
        GioHangController dc = new GioHangController();
        ...
        public ActionResult Payment()
        {
            ...
            pay.AddRequestData("vnp_Amount", dc.getTongTien().ToString() + "00000"); //số tiền cần thanh toán, công thức: số tiền * 100 - ví dụ 10.000 (mười nghìn đồng) --> 1000000
